...
namespace WatchList.Test.CoreTest.FilterItemTest
{
    public class FilterByStatusTest
    {
        ...
        {
            // Assert
            CheckListEqualAfterApplyFilter(watchItems, StatusCinema.Viewed, expectWatchItems);
        }
        ...
        {
            // Assert
            CheckListEqualAfterApplyFilter(watchItems, StatusCinema.Planned, expectWatchItems);
        }
        ...
        {
            // Assert
            CheckListEqualAfterApplyFilter(watchItems, StatusCinema.Thrown, expectWatchItems);
        }
        ...
        {
            // Assert
            CheckListEqualAfterApplyFilter(watchItems, StatusCinema.Look, expectWatchItems);
        }

        private void CheckListEqualAfterApplyFilter(List<WatchItem> watchItems, StatusCinema statusCinema, List<WatchItem> expectWatchItems)
        {
            // Arrange
