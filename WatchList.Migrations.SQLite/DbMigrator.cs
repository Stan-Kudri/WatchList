...
namespace WatchList.Migrations.SQLite
{
    public class DbMigrator
    {
        ...
        public DbMigrator(WatchCinemaDbContext db)
        {
            _db = db;
        }
        ...
        public void Migrate()
        {
            ...
            var migrate = _db.Database.GetInfrastructure().GetService<IMigrator>() ?? throw new InvalidOperationException("Unable to found migrator service.");
